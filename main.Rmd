...
cat(
  "<script src='https://unpkg.com/tensor-diagrams@0.2.2/dist/esbuild/tensor-diagrams.js'></script>",
...
TensorDiagram.new()
  ...
  .addTensor("x", {x: 2, y: 0}, ["tx"], ["xt"], [], ["xo"], "dot")
  .addTensor("T", {x: 3, y: 0}, ["xt"], ["ty"])
  .addTensor("y", {x: 4, y: 0}, ["ty"], ["yt"], [], ["yo"], "dot")
  .addTensor("T", {x: 5, y: 0}, ["yt"], ["tz"])
  .addTensor("z", {x: 6, y: 0}, ["tz"], [], [], ["zo"], "dot")
  .addTensor("O", {x: 2, y: 1}, [], [], ["xo"], ["j1"])
  .addTensor("O", {x: 4, y: 1}, [], [], ["yo"], ["j2"])
  .addTensor("O", {x: 6, y: 1}, [], [], ["zo"], ["j3"])
  ...
  .setSize(400, 200)
  .setColorScheme(["x", "y", "z"], ['black','black','black'], 'google10')
  .draw("#example1");
...
<!-- using temporal name '1' for 'dots'-->

```{js, results='asis', echo=FALSE, message=FALSE}

TensorDiagram.new()
  .addTensor("1", {x: 0, y: 0}, [], [], [], [], "dot")
  .addTensor("1", {x: 2, y: 0}, [], ["i"], [], [], "dot")
  .addTensor("1", {x: 5, y: 0}, ["i"], ["j"], [], [], "dot")
  .addTensor("1", {x: 8, y: 0}, ["i"], ["k"], [], ["j"], "dot")
  .setSize(580, 140)
  .setColorScheme(['1'], ['black'])
  .draw("#example7");
...
TensorDiagram.new()
  .addTensor("dot", {x: 1, y: 0}, ["i"], ["j"], [], ["k"], "dot")
  .addTensor("S", {x: 1, y: 1}, [], [], ["k"], [])
...
<!-- This diagram has the problem that the label of the first tensor is behind the index "up" -->

```{js, results='asis', echo=FALSE, message=FALSE}

TensorDiagram.new()
  .addTensor("T", {x: 1, y: 0}, ["n"], ["k"], ["m"], ["t"])
  .addTensor("W", "right", ["k"], ["q"])
  .addContraction(0, 1, "k")
  .setSize(220, 140)
  .draw("#einsumindl4");
...
TensorDiagram.new()
  .addTensor("A", {x: 1, y: 0}, ["i"], ["j"], [], [], "dot")
  .setSize(160, 110)
  .setColorScheme(['A'], ['black'], 'tensornetwork')
  .draw("#einsumindl6");
...
<!-- curved contraction doesn't work -->
