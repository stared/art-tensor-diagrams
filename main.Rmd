...
cat(
  "<script src='https://unpkg.com/tensor-diagrams@0.2.1/dist/esbuild/tensor-diagrams.js'></script>",
...
<div class="equation">
 <div id="einsumindl5_1" class="eq-elem">
  <div class="eq-diagram"></div>
 </div>
 <div class="eq-elem">$$\hspace{0.3cm}=\hspace{0.3cm}$$</div>
 <div id="einsumindl5_2" class="eq-elem">
  <div class="eq-diagram"></div>
 </div>
 <div class="eq-elem">$$\hspace{0.3cm}\rightarrow\hspace{0.3cm}$$</div>
 <div class="eq-elem tensor-eq-B">$$B_{ji}$$</div>
 <div class="eq-elem">$$\hspace{0.3cm}=\hspace{0.3cm}$$</div>
 <div class="eq-elem tensor-eq-A">$$A_{ij}$$</div>
</div>

<!-- It is not possible to mix parts of an equation with separate diagrams, 
since the code assumes that the diagram and the equation are the same div -->
