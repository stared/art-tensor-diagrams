...
In this article we use **tensor** as in `torch.Tensor` or TensorFlow - i.e. multidimensional arrays of numbers with  some additional structure. This a very specific case of would a mathematican call a tensor.
