...
cat(
  "<script src='https://unpkg.com/tensor-diagrams@0.1.1/dist/esbuild/tensor-diagrams.js'></script>",
...
const diagram1 = new TensorDiagram(tensors_einsumindl1, contractions_einsumindl1, []);
diagram1.setSize(220, 120).draw("#einsumindl1")
...
const diagram2 = new TensorDiagram(tensors_einsumindl2, contractions_einsumindl2, []);
diagram2.setSize(100, 120).draw("#einsumindl2")
